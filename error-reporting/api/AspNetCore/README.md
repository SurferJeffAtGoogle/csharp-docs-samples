...
A sample demonstrating how to use the Google Cloud Stackdriver AspNetCore ASP.NET Core NuGet package
...
[this older sample](https://github.com/GoogleCloudPlatform/dotnet-docs-samples/tree/vs2015/error-reporting/api/AspNetCore).
